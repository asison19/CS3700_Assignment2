...
{ 
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                barrier.release(); //assume thread2 is slower thus it release() but, FOR EXAMPLE we can check an atomic counter to have last thread release() 
    ...
    { 
        ...
        Thread t1 = new Thread(new Lect4_2.MyThread1(BR)); 

        Thread t2 = new Thread(new Lect4_2.MyThread2(BR)); 
